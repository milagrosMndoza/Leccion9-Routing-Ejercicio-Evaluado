...
class Courses extends React.Component {
	...
	let cssCourse = [
			...
			{
				imgSrc: "img/courses/CSS/css3.png",
			...
			{
				imgSrc: "img/courses/CSS/css4.png",
        ...
        {
				imgSrc: "img/courses/CSS/css5.png",
				...
				imgSrc: "img/courses/CSSL/css6.png",
		...
		switch (route) {
			...
			case 'css':
				CurrentList = cssCourse.map( (item, index) => {
					return <li key = {index}> {item.imgSrc} </li>
				});
				break;
			case 'javascript':
